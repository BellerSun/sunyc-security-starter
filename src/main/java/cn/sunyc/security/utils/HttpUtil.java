...
public class HttpUtil {
	...
	public static String get(String urlStr, Map<String, String> paramMap) throws Exception {
		return get(urlStr,paramMap,null);
	}
	 ...
	 *            http连接
	 */
	private static void setHttpUrlConnectionHeader(HttpURLConnection conn, Map<String, String> headerMap){
		if (null == headerMap || headerMap.isEmpty()) {return;}
